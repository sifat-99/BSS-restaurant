...
const Orders = () => {
    ...
    const [localSearch, setLocalSearch] = useState<any>(search);
    ...
    const handleStatusClick = (event: any, orderId: any) => {
    ...
    const handleOrderDelete = (orderId: any) => {
                ...
                {loading && orders.length === 0 ? (
                    ...
                    <Grid container spacing={3}>
                        {orders.map((order: any) => {
                            ...
                            const totalQuantity =
                                items.reduce((sum: any, item: any) => sum + (item.quantity || 1), 0) ||
                                order.totalQuantity ||
                                items.length ||
                                0;
