...
interface ProfileInfoItemProps {
    icon: ReactElement<{ color?: "primary" }>;
    label: string;
    value?: string | number;
}
...
const Profile = () => {
    ...
    const reduxUser = useSelector((state: RootState) => state.auth.user) as ProfileUser | null;
    const theme = useTheme();

    const [user, setUser] = useState<ProfileUser | null>(reduxUser);
